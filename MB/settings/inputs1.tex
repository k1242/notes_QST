...
% \cite{bardarson_unbounded_2012} -- Unbounded Growth of Entanglement in Models of Many-Body Localization

% \cite{wei_characterization_2020} -- Characterization of many-body mobility edges with random matrices

% \cite{khlebnikov_thermalization_2014} -- Thermalization of isolated quantum systems


% \cite{Choi_2016} -- Exploring the many-body localization transition in two dimensions
